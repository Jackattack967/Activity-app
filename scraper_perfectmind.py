...
PerfectMind (used by many BC municipalities, including Coquitlam, Port Moody
and New Westminster) renders its drop-in schedules through a JSON API rather
than static HTML. The flow is:
...
`scraper.py` chooses between this and the other platform modules.
"""
